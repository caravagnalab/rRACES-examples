...
saveRDS("SPN02/tissue/clone3_clock.rds", clone3_born)
...
phylo_forest <- m_engine$place_mutations(sampled_phylogeny, 100)
# save the phylogenetic forest in the file "phylo_forest.sff"
phylo_forest$save("SPN02/tissue/phylo_forest.sff")