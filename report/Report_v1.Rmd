...
```{r grouth_dynamics, out.width = '100%',fig.align='center',fig.height=8,echo=FALSE,include=FALSE}
snapshot_dir <- params$files$sim
snapshot_name <- params$spn
basedir <- gsub(pattern = snapshot_name,replacement = "",x = snapshot_dir)
setwd(basedir)
plot <- plot_tumour_dynamics(snapshot_name,sample_forest)
plot$plot_dynamics
```
## Sampling
