...
# seq_res_tumour <- map_muts_to_karyotype(seq_res_rds,phylo_forest)
...
source("/orfeo/cephfs/scratch/cdslab/ggandolfi/prj_races/rRACES-examples/SPN01/alluvial_plot_karyptypes.R", local = knitr::knit_global())
