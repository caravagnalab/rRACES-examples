...
```{r growth_dynamics, out.width = '100%',fig.align='center',fig.height=8,echo=FALSE,include=TRUE}
...
```{r sampling_dynamics, echo=FALSE, out.width = '100%',fig.align='center',fig.height=3, fid.width=10}
