...
<!-- # if (!exists("params")) { -->
<!-- #   params <- yaml::read_yaml("../SCOUT/SPN01/params_50x_0.3p.yml") -->
<!-- # } -->
<!-- ``` -->
...
```{r growth_dynamics, out.width = '100%',fig.align='center',fig.height=8,echo=FALSE,include=FALSE}
basedir <- params$files$base_dir ## in questo caso come /orfeo/cephfs/scratch/cdslab/shared/SCOUT/SPNID
setwd(basedir)
...
```{r sampling_dynamics, echo=FALSE, out.width = '100%',fig.align='center',fig.height=4, fid.width=10}
...
<!-- Th single cell heatmap of copy number profiles across different clones and samples can be downloaded from this link: [single_cell_heatmap](/orfeo/cephfs/scratch/cdslab/ggandolfi/prj_races/REPO_UPDATED/ProCESS-examples/report/heatmap.pdf). -->
