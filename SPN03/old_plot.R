...
ggsave(filename = 'plots/SPN03_seq_plot.png', dpi = 300, plot = gw_plot,  width = 210, height = 297, units = "mm")
...
ggsave(filename = 'plots/SPN03_histogram.png', plot = hist, dpi = 300,  width = 210, height = 297, units = "mm")
...
ggsave(filename = 'plots/SPN03_marginal.png', plot = marg, dpi = 300,  width = 210, height = 297, units = "mm")
