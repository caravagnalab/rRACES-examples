...
rRACES::plot_histogram_vaf(seq_results, 
                   cuts = c(0.05, 1), 
                   colour_by = 'classes')
...
patchwork::wrap_plots(rRACES::plot_marginals(seq_results, 
                                     chromosome = '1', 
